...
namespace AppRpgEtec.ViewModels
{
    ...
    {
        private static string conexaoAzureStorage = "DefaultEndpointsProtocol=https;AccountName=marinsstorage;AccountKey=ke/YfUEj6wFMdcdGQ/FUqD4Dm1aoCtAuJjxMYup8B0liBiQu0xWSCFGHOmSEtKHmGntpoQRWToSi+AStBNTOGw==;EndpointSuffix=core.windows.net";
